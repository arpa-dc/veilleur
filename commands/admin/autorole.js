...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('autorole')
    .setDescription('Configurer un menu de rôles automatiques')
    ...
    .addStringOption(o => o.setName('couleur').setDescription('Couleur hex (ex: #3498db)').setRequired(false))
    .addStringOption(o => o.setName('footer').setDescription('Footer de l\'embed').setRequired(false))
    ...
    .addStringOption(o => o.setName('option6').setDescription('label|description|roleId').setRequired(false))
    .addStringOption(o => o.setName('option7').setDescription('label|description|roleId').setRequired(false))
    .addStringOption(o => o.setName('option8').setDescription('label|description|roleId').setRequired(false))
    .addStringOption(o => o.setName('option9').setDescription('label|description|roleId').setRequired(false))
    .addStringOption(o => o.setName('option10').setDescription('label|description|roleId').setRequired(false)),
  ...
  async execute(interaction) {
    ...
    writeJSON('autorole_config.json', config);

    const colorInt = parseInt(couleur.replace('#', ''), 16) || 0x3498db;
    ...
    await interaction.reply({ content: '✅ Menu de rôles publié !', ephemeral: true });
  },
};
